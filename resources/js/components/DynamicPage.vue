                    ...
                    <form @submit.prevent="editMode ? editPage() : newPage()">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input v-model="form.parentSlug" type="text" name="parentSlug" class="form-control"
                                    :class="{ 'is-invalid': form.errors.has('parentSlug') }">
                                <has-error :form="form" field="parentSlug"></has-error>
                            </div>
                            <div class="form-group">
                                <label>Slug</label>
                            ...
                            <div class="form-group">
                                ...
                                <input v-model="form.meta.underStatisticsVideoTitle" type="text"
                                    name="underStatisticsVideoTitle" class="form-control"
...
<script>
    export default {
        ...
        methods: {
            ...
            getPages() {
                axios.get('/api/admin/dynamic-pages')
                    .then(
                        ({
                            data
